...
TMP_ROOT="${TMPDIR:-/tmp}"
API_LOG="$TMP_ROOT/proveria-ocr-pdf-api.log"
WORKER_LOG="$TMP_ROOT/proveria-ocr-pdf-worker.log"
API_PID=""
WORKER_PID=""
...
log "running OCR PDF smoke flow"
PROVERIA_SMOKE_API_URL="$API_URL" pnpm --filter @proveria/worker smoke:ocr-pdf

log "OCR PDF smoke passed"
