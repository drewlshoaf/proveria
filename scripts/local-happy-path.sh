...
TMP_ROOT="${TMPDIR:-/tmp}"
API_LOG="$TMP_ROOT/proveria-happy-path-api.log"
WORKER_LOG="$TMP_ROOT/proveria-happy-path-worker.log"
API_PID=""
WORKER_PID=""
...
log "running desktop-signed smoke flow"
PROVERIA_SMOKE_API_URL="$API_URL" pnpm --filter @proveria/desktop smoke:happy-path
